...
function populateActivityTable() {
    ...
    if (!tableBody) return;
     ...
     const activities = [
        { date: '2026-08-16', activity: 'Submitted Math Assignment', status: 'success' },
        { date: '2026-08-15', activity: 'New announcement posted by instructor', status: 'info' },
        { date: '2026-08-14', activity: 'Attendance warning issued', status: 'warning' },
        { date: '2026-08-14', activity: 'Library book borrowed: "HTML Design Guide"', status: 'success' },
        { date: '2026-08-14', activity: 'Exam schedule released for Final Exams', status: 'info' },
        { date: '2026-08-13', activity: 'Late submission flagged for History Essay', status: 'danger' }
    ];
